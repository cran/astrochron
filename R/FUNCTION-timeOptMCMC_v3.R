...
# Find maximum log-likelihood and detect nburnin
# extract column 1 of samplemat
# imlogLik is the index
imlogLik=which.max(samplemat[,1])
logpdfmax=samplemat[imlogLik,1] 
...
# burn in detection, using fraction threshold criterion
  if(burnin>=0)
   {
     burnintol=burnin  
     logpdfburnin=logpdfstart+burnintol*(logpdfmax-logpdfstart)
...
# calculate periods at maximum log-likelihood
MAPperiods=calcPeriods(g=c(samplemat[imlogLik,4],samplemat[imlogLik,5],samplemat[imlogLik,6],samplemat[imlogLik,7],samplemat[imlogLik,8]),k=samplemat[imlogLik,3])
...
#  points(samplemat[imlogLik,2],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,2],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,3],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,3],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,4],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,4],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,5],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,5],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,6],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,6],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,7],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,7],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,8],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,8],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
...
#  points(samplemat[imlogLik,9],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,9],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
  if(iopt==1)
   {
...
#     points(samplemat[imlogLik,11],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#     points(samplemat[imlogLik,11],samplemat[imlogLik,1],cex=2,col="purple4",pch=16)
   }
...
#  points(samplemat[imlogLik,10],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#  points(samplemat[imlogLik,10],samplemat[imlogLik,1],cex=2,col="mediumblue",pch=16)
  if(iopt==1)
   {
...
#     points(samplemat[imlogLik,12],samplemat[imlogLik,1],cex=2,col="white",pch=21)
#     points(samplemat[imlogLik,12],samplemat[imlogLik,1],cex=2,col="purple4",pch=16)
   }
...
#  abline(v=samplemat[imlogLik,2],lty=3,lwd=2,col="red")
  abline(v=c(sedmin,sedmax)*100,lty=4,col="slategray",lwd=1.5)
...
#  abline(v=samplemat[imlogLik,3],lty=3,lwd=2,col="red")
  abline(v=c(kAve-kSd,kAve+kSd),lty=4,col="slategray",lwd=1.5)
...
#  abline(v=samplemat[imlogLik,4],lty=3,lwd=2,col="red")
  abline(v=c(gAve[1]-gSd[1],gAve[1]+gSd[1]),lty=4,col="slategray",lwd=1.5)
...
#  abline(v=samplemat[imlogLik,5],lty=3,lwd=2,col="red")
  abline(v=c(gAve[2]-gSd[2],gAve[2]+gSd[2]),lty=4,col="slategray",lwd=1.5)
...
#  abline(v=samplemat[imlogLik,6],lty=3,lwd=2,col="red")
  abline(v=c(gAve[3]-gSd[3],gAve[3]+gSd[3]),lty=4,col="slategray",lwd=1.5)
...
#  abline(v=samplemat[imlogLik,7],lty=3,lwd=2,col="red")
  abline(v=c(gAve[4]-gSd[4],gAve[4]+gSd[4]),lty=4,col="slategray",lwd=1.5)
...
#  abline(v=samplemat[imlogLik,8],lty=3,lwd=2,col="red")
  abline(v=c(gAve[5]-gSd[5],gAve[5]+gSd[5]),lty=4,col="slategray",lwd=1.5)
...
#    abline(v=samplemat[imlogLik,11],lty=3,lwd=2,col="red")
    }
#  abline(v=samplemat[imlogLik,9],lty=3,lwd=2,col="red")  
  abline(v=c(rhomin,rhomax),lty=4,col="slategray",lwd=1.5)
...
#    abline(v=samplemat[imlogLik,12],lty=3,lwd=2,col="red")
   }
#  abline(v=samplemat[imlogLik,10],lty=3,lwd=2,col="red") 
  abline(v=c(exp(sigmaEmin),exp(sigmaEmax)),lty=4,col="slategray",lwd=1.5)
